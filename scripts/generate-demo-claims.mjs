...
This is the boundary for what is said about METIS to anyone outside the team. It was first written for an internal demo planned for Fri 18 Sep 2026, which \`docs/DIRECTIVE.md\` withdrew on 15 Sep; no demo is scheduled. Every line cites what it was read from. An omission here is worse than an ugly truth, so the sections below are generated to include rows that read badly.
