...
Registry            75 passed  - one behaviour suite, run against memory and a
                                 real PostgreSQL
Catalogue           52 passed  - taxonomy, offers, creatives, policies, boosts,
                                 connectors, placements and the ranking
                                 function; one suite over memory and a real
                                 PostgreSQL
