...
export const targetingPolicies: TargetingPolicy[] = [
  ...
  },
  {
    ...
    conditions: [
      // The bureau's band, not the status the tenant records against the
      // account. The value arrives from conn_credit_bureau, so a refusal here
      // can name the system that supplied the evidence - G-069.
      { field: 'customer.credit_band', operator: 'in', value: ['A', 'B', 'C'] },
  ...
  },
  {
    ...
    conditions: [{ field: 'customer.address.fibre_available', operator: 'eq', value: true }],
  ...
  },
  {
    ...
    conditions: [{ field: 'customer.usage.pct_of_allowance_3mo_avg', operator: 'gte', value: 0.8 }],
  ...
  },
  {
    ...
    conditions: [{ field: 'customer.contract.days_to_end', operator: 'lte', value: 90 }],
  ...
  },
  {
    ...
    conditions: [{ field: 'customer.events.pac_requested_within_days', operator: 'lte', value: 14 }],
  ...
  },
  {
    ...
    conditions: [{ field: 'context.offer.monthly_delta', operator: 'lte', value: 0 }],
  ...
  },
  {
    ...
    conditions: [{ field: 'customer.device.residual_value', operator: 'gt', value: 10800 }],
  ...
  },
  {
    ...
    conditions: [{ field: 'customer.usage.months_of_history', operator: 'gte', value: 3 }],
