...
- Name: apps\console\tests\e2e\compiler.spec.ts >> compiler output in the console >> shows why it fails, and what to do about it
- Location: apps\console\tests\e2e\compiler.spec.ts:29:7
