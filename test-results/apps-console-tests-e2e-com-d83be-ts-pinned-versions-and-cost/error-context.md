...
- Name: apps\console\tests\e2e\compiler.spec.ts >> compiler output in the console >> shows a passing strategy with its pinned versions and cost
- Location: apps\console\tests\e2e\compiler.spec.ts:47:7
