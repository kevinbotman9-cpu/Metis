...
- Name: apps\console\tests\e2e\compiler.spec.ts >> compiler output in the console >> flags a strategy that fails to compile in the list
- Location: apps\console\tests\e2e\compiler.spec.ts:14:7
